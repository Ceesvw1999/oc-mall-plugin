<?php return [
    'plugin' => [
        'name' => 'Plugin naam',
        'description' => 'Plugin beschrijving.',
    ],
    'titles' => [
        'products' => [
            'create' => 'Nieuw product',
            'update' => 'Wijzig product',
            'preview' => 'Bekijk product',
        ],
        'categories' => [
            'create' => 'Nieuwe categorie',
            'update' => 'Wijzig categorie',
            'preview' => 'Bekijk categorie',
        ],
        'orders' => [
            'show' => 'Bestelgegevens',
            'export' => 'Exporteer bestellingen',
        ],
        'discounts' => [
            'create' => 'Nieuwe korting',
            'update' => 'Bewerk korting',
            'preview' => 'Bekijk korting',
        ],
        'services' => [
            'create' => 'Nieuwe dienst',
            'update' => 'Bewerk dienst',
        ],
        'shipping_methods' => [
            'create' => 'Nieuwe verzendmethode',
            'update' => 'Bewerk verzendmethode',
            'preview' => 'Bekijk verzendmethode',
        ],
        'payment_methods' => [
            'create' => 'Nieuwe betaalmethode',
            'edit' => 'Bewerk betaalmethode',
            'reorder' => 'Opnieuw ordenen',
        ],
        'custom_field_options' => [
            'edit' => 'Bewerk veld opties',
        ],
        'properties' => [
            'create' => 'Nieuwe eigenschappen',
            'edit' => 'Bewerk eigenschappen',
        ],
        'order_states' => [
            'create' => 'Nieuwe status',
            'edit' => 'Bewerk status',
            'reorder' => 'Status opnieuw ordenen',
        ],
        'brands' => [
            'create' => 'Nieuw merk',
            'edit' => 'Bewerk merk',
        ...
        'notifications' => [
            'update' => 'Bewerk notificatie',
        ],
        'taxes' => [
            'create' => 'Nieuwe belasting',
            'update' => 'Bewerk belasting',
        ],
        'reviews' => [
            'create' => 'Maak review',
            'update' => 'Bewerk review',
        ],
    ],
    'menu_items' => [
    ...
    'currency_settings' => [
        'label' => 'Valua',
        'description' => 'Stel uw valuta in',
        'currencies' => 'Voer alleen officiële valutacodes van 3 tekens in.',
    ...
    'payment_gateway_settings' => [
        ...
        'description' => 'Configureer uw betalingsgateways',
        'stripe' => [
            'api_key' => 'Stripe API Key',
            'api_key_comment' => 'U vindt deze sleutel in uw Stripe Dashboard',
            'publishable_key' => 'Stripe Publishable Key',
            'publishable_key_comment' => 'U vindt deze sleutel in uw Stripe Dashboard',
        ],
        'paypal' => [
    ...
    'notification_settings' => [
        'label' => 'Notificaties',
        'description' => 'Configureer winkel meldingen',
    ],
    'price_category_settings' => [
        'label' => 'Prijs categorieën',
        'description' => 'Configureer extra prijscategorieën',
    ],
    'order_state_settings' => [
        'description' => 'Configureer bestelling staten',
    ],
    'payment_method_settings' => [
        'description' => 'Beheer betalingsmethoden',
    ],
    ...
    'general_settings' => [
        ...
        'product_page' => 'Productdetails pagina',
        'product_page_comment' => 'Hier worden de productdetails weergegeven',
        'address_page' => 'Adrespagina',
        'address_page_comment' => 'Het component AddressForm moet op deze pagina aanwezig zijn',
        'checkout_page' => 'Checkout page',
        'checkout_page_comment' => 'The checkout component has to be present on this page',
        'account_page' => 'Mijn account pagina',
        'account_page_comment' => 'Het myAccount component moet op deze pagina aanwezig zijn',
        'cart_page' => 'Winkelwagen',
        'cart_page_comment' => 'Het winkelwagen component moet op deze pagina aanwezig zijn',
        'category_page' => 'Categoriepagina voor productenlijst',
        'redirect_to_cart' => 'Redirect naar winkelwagen',
        'redirect_to_cart_comment' => 'Redirect naar winkelwagen nadat een product is toegevoegd door een gebruiker',
        'use_state' => 'Use State/County/Province field',
        'use_state_comment' => 'Klanten moeten een Staat/Land/Provincie selecteren bij het aanmelden',
        'admin_email' => 'Admin email',
        'admin_email_comment' => 'Beheerdersmeldingen worden naar dit adres verzonden',
        'base' => 'Basis instellingen',
        'links' => 'CMS paginas',
        'links_comment' => 'Kies welke paginas worden gebruikt om producten op te weergeven',
        'customizations' => 'Aanpassingen',
        'customizations_comment' => 'Pas de functies van uw webwinkel aan',
        'order_number_start' => 'Eerste bestelnummer',
        'order_number_start_comment' => 'Eerste ID van de eerste bestelling',
